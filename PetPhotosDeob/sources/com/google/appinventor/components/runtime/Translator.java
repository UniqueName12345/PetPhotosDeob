...
public final class Translator extends AndroidNonvisibleComponent {
    ...
    public void performRequest(String languageToTranslateTo, String textToTranslate) {
        ...
        try {
            ...
            TranslatorToken.request request = TranslatorToken.request.newBuilder().setToken(token).setTotranslate(textToTranslate).setSourcelanguage(srcLanguage).setTargetlanguage(targetLanguage).m386build();
    ...
    @SimpleProperty(description = "The API Key to use. MIT App Inventor will automatically fill this value in. You should not need to change it.", userVisible = SyntaxForms.DEBUGGING)
