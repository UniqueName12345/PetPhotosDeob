...
public class XML {
    ...
    private static boolean parse(XMLTokener x, JSONObject context, String name) throws JSONException {
        ...
        if (token == BANG) {
            ...
            while (true) {
                Object nextToken = token4 == null ? x.nextToken() : token4;
                if (nextToken instanceof String) {
                    String string2 = (String) nextToken;
                    token4 = x.nextToken();
                    if (token4 == EQ) {
    ...
    public static String toString(Object object, String tagName) throws JSONException {
        ...
        return tagName == null ? new StringBuffer().append("\"").append(string).append("\"").toString() : string.length() == 0 ? new StringBuffer().append("<").append(tagName).append("/>").toString() : new StringBuffer().append("<").append(tagName).append(">").append(string).append("</").append(tagName).append(">").toString();
    }
}
