...
public class Declaration implements SourceLocator {
    ...
    public void load(AccessExp access, int flags, Compilation comp, Target target) {
        ...
        if (!(target instanceof IgnoreTarget)) {
            ...
            if (isAlias() && (this.value instanceof ReferenceExp) && (orig = (rexp = (ReferenceExp) this.value).binding) != null && (((flags & 2) == 0 || orig.isIndirectBinding()) && (owner == null || !orig.needsContext()))) {
                ...
                if (!isIndirectBinding() && (flags & 2) != 0) {
                    ...
                    if (this.field != null) {
                        ...
                        return;
                    } else if (this.value != QuoteExp.undefined_exp && ignorable() && (!(this.value instanceof LambdaExp) || !(((LambdaExp) this.value).outer instanceof ModuleExp))) {
