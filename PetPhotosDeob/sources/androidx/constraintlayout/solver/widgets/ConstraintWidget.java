...
public class ConstraintWidget {
    ...
    public void addToSolver(LinearSystem system) {
        ...
        if (this.mParent != null) {
            if (this.mParent != null) {
                horizontalParentWrapContent = this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            } else {
                horizontalParentWrapContent = false;
            }
            if (this.mParent != null) {
                verticalParentWrapContent = this.mParent.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
            } else {
